...
def main():
    os.chdir(r'C:\Users\Hayden Mierl\Documents\Melee E\Smash Stats\data\Ultimate\Singles')
    Ultimate_rater = ELO()
...
##    OutData = sorted(Ultimate_rater.players.items(), key=operator.itemgetter(1))
